...
export default function Footer() {
  return (
    <footer className="bg-white text-white text-center py-6 mt-10">
  <div className="container mx-auto px-4">
    <p className="text-sm text-gray-800">&copy; {new Date().getFullYear()} Rutuja Kodag. All rights reserved.</p>
